        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CategoryCountProduct = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductCountView = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DetailReceipts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DetailReceipts_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DetailReceipts_Receipts_ReceiptId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DetailReceipts_ProductId",
                table: "DetailReceipts",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_DetailReceipts_ReceiptId",
                table: "DetailReceipts",
                column: "ReceiptId");
